 ...
 * Edit by kyle astudillo on 5/8/17
 */

public class HomeFragment extends android.support.v4.app.Fragment implements RecyclerViewClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        //Log.i("HomeFragment", "It worked succesfully" + itemListener.toString() + " ");
